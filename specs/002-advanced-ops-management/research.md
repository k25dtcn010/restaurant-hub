...
export const dishModifiers = sqliteTable("dish_modifiers", {
...
export const dishCategories = sqliteTable("dish_categories", {
  dishId: integer("dish_id").notNull().references(() => dishes.id),
...
export const variantRecipes = sqliteTable("variant_recipes", {
  variantId: integer("variant_id").notNull().references(() => dishVariants.id),
