		...
		<Dialog open={open} onOpenChange={onOpenChange}>
			<DialogContent>
				<DialogHeader>
					...
					<DialogDescription>
						Set the minimum stock level. You'll receive an alert when stock falls
							...
							<div className="bg-destructive/10 border border-destructive/20 rounded-lg p-3">
								<div className="flex items-center gap-2">
									...
									<div className="text-sm">
										...
										Current stock ({ingredient.quantity} {ingredient.unit}) is below the
										new threshold ({thresholdValue} {ingredient.unit})
									</div>
								</div>
							</div>
						)}
